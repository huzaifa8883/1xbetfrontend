...
FetchCatalog: function (marketId) {
    let self = this;
    // 1. URL Correction: catalog2 ke baad extra slash aur /v1 ka dhyan rakhein
    // Agar API_BASE use kar rahe hain to: var qs = API_BASE + "/v1/markets/catalog2?id=" + marketId;
    ...
    $.getJSON(qs, function (catalog) {
        ...
        console.error("Catalog API Failed: ", jqXHR.status);
    });
},
        ...
        if (jqXhr.status == 401) {
            ...
            self.Order["error"] = errorText;
                ...
                ListOrders: function () {
                    ...
                    if (!this.Catalog || !this.Catalog.eventId || !this.Catalog.marketId) return;
