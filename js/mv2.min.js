...
function MarketFactory() {
        ...
        if (jqXhr.status == 401) {
            ...
            self.Order["error"] = errorText;
                ...
                TrackOrder: function (requestId) {
                    const self = this;
                    const token = getCookie('wex3authtoken') || localStorage.getItem('token');
    ...
    // ✅ Strong guard
    if (!this.Catalog || !this.Catalog.eventId || !this.Catalog.marketId) {
        console.warn('Catalog not ready:', this.Catalog);
        return;
    }
